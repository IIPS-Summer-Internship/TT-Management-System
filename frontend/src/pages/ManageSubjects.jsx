    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex space-x-2">
                    <button
                      className={`bg-emerald-500 hover:bg-emerald-600 text-white p-2 rounded-lg transition-colors duration-200 ${userRole === "user"
                    ...
                    <button
                      className={`bg-rose-500 hover:bg-rose-600 text-white p-2 rounded-lg transition-colors duration-200 ${userRole === "user"
                        ? "pointer-events-none opacity-50"
                        : ""
                        }`}
                      onClick={() => handleDelete(subject.id)}
      ...
      {showAddDialog && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          {/* I have removed 'overflow-y-auto' from this div to fix the dropdown clipping issue */}
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <SearchableSelect
                  ...
                  onSelect={(value) => setNewSubject(prev => ({
                    ...prev,
                    course_id: value,
                    course_code: courses.find(c => c.ID == value)?.Code || ""
                  }))}
